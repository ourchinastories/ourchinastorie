...
(function () {
        ...
        return {
            define: function (b, d) {
                ...
                if (g.getListenerIndex(d) < 0) {
                    ...
                    j.fn = d;
                    j.priority = i;
                    for (var r = g.length - 1; r >= 0; r--)if (g[r].priority <= i) {
                        g.splice(r + 1, 0, j);
                        return {removeListener: n}
                    }
                    g.unshift(j)
                }
                return {removeListener: n}
                ...
                return function (i, j, n) {
                    ...
                    if (g) {
                        ...
                        if (r.length)for (var r = r.slice(0), y, o = 0; o < r.length; o++) {
                            if (g.errorProof)try {
                                y =
                                    r[o].call(this, n, j, b, h)
                            } catch (q) {
                            } else y = r[o].call(this, n, j, b, h);
    ...
    CKEDITOR.env || (CKEDITOR.env = function () {
        var a = navigator.userAgent.toLowerCase(), d = a.match(/edge[ \/](\d+.?\d*)/), b = a.indexOf("trident/") > -1, b = !(!d && !b), b = {
            ie: b,
            edge: !!d,
        ...
        if (b.ie)b.cssClass = b.cssClass + (" cke_browser_ie" + (b.quirks ?
                "6 cke_browser_iequirks" : b.version));
    ...
    CKEDITOR.dom = {};
    (function () {
        var a = [], d = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "", b = /&/g, c = />/g, e = /</g, f = /"/g, h = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g, i = {
            lt: "<",
            gt: ">",
            amp: "&",
            quot: '"',
        ...
        CKEDITOR.tools = {
            ...
            extend: function (a) {
                ...
                for (var i = 1; i < g; i++) {
                    var o = arguments[i], d;
                    for (d in o)if (b === true || a[d] == null)if (!c || d in c)a[d] = o[d]
                }
                return a
            },
            ...
            cssStyleToDomStyle: function () {
                var a = document.createElement("div").style, g = typeof a.cssFloat != "undefined" ? "cssFloat" : typeof a.styleFloat != "undefined" ? "styleFloat" : "float";
                return function (a) {
            ...
            buildStyleHtml: function (a) {
                for (var a =
                    [].concat(a), g, b = [], c = 0; c < a.length; c++)if (g = a[c])/@import|[{}]/.test(g) ? b.push("<style>" + g + "</style>") : b.push('<link type="text/css" rel=stylesheet href="' + g + '">');
                return b.join("")
            },
            ...
            transformPlainTextToHtml: function (a,
                                                g) {
                var b = g == CKEDITOR.ENTER_BR, c = this.htmlEncode(a.replace(/\r\n/g, "\n")), c = c.replace(/\t/g, "&nbsp;&nbsp; &nbsp;"), i = g == CKEDITOR.ENTER_P ? "p" : "div";
                if (!b) {
                    var o = /\n{2}/g;
                    if (o.test(c))var d = "<" + i + ">", j = "</" + i + ">", c = d + c.replace(o, function () {
                            return j + d
                        }) + j
                }
                c = c.replace(/\n/g, "<br>");
            ...
            getUniqueId: function () {
                for (var a = "e", g = 0; g < 8; g++)a = a + Math.floor((1 + Math.random()) * 65536).toString(16).substring(1);
                return a
            },
            ...
            indexOf: function (a, g) {
                if (typeof g == "function")for (var b = 0, c = a.length; b < c; b++) {
                    ...
                    b = 0;
                    for (c = a.length; b < c; b++)if (a[b] === g)return b
                }
                return -1
            },
            search: function (a, b) {
            ...
            createClass: function (a) {
                var b = a.$, c = a.base, i = a.privates || a._, d = a.proto, a = a.statics;
                !b && (b = function () {
                    c && this.base.apply(this, arguments)
                });
                if (i)var o = b, b = function () {
            ...
            normalizeCssText: function (a, b) {
                var c = [], i, d = CKEDITOR.tools.parseCssText(a, true, b);
                for (i in d)c.push(i + ":" + d[i]);
                c.sort();
            ...
            objectCompare: function (a, b, c) {
                ...
                if (!c)for (i in b)if (a[i] != b[i])return false;
                return true
            },
            ...
            convertArrayToObject: function (a, b) {
                ...
                for (var i = 0, d = a.length; i < d; ++i)c[a[i]] = b;
                return c
            },
            fixDomain: function () {
                for (var a; ;)try {
            ...
            enableHtml5Elements: function (a, b) {
                for (var c = ["abbr", "article", "aside", "audio", "bdi", "canvas", "data", "datalist", "details", "figcaption", "figure", "footer", "header", "hgroup", "main", "mark", "meter", "nav", "output", "progress", "section", "summary",
                    "time", "video"], i = c.length, d; i--;) {
                    d = a.createElement(c[i]);
                    b && a.appendChild(d)
                }
            },
            checkIfAnyArrayItemMatches: function (a, b) {
                for (var c = 0, i = a.length; c < i; ++c)if (a[c].match(b))return true;
                return false
            },
            checkIfAnyObjectPropertyMatches: function (a, b) {
                for (var c in a)if (c.match(b))return true;
                return false
            },
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, d = function (a, b) {
            ...
            table: 1,
            ul: 1
        }, f = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, h = {}, i = {"#": 1}, j = {
            center: 1,
            dir: 1,
            noframes: 1
        };
        a(b, {
            ...
            video: 1,
            wbr: 1
        }, i, {acronym: 1, applet: 1, basefont: 1, big: 1, font: 1, isindex: 1, strike: 1, style: 1, tt: 1});
        a(c, e, b, j);
        d = {
            a: d(b, {a: 1, button: 1}),
            abbr: b,
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        appendTo: function (a, d) {
            ...
            function b(c) {
                ...
                if (!(c.nodeType != CKEDITOR.NODE_ELEMENT && c.nodeType != CKEDITOR.NODE_DOCUMENT_FRAGMENT)) {
                    ...
                    if (a)for (var c = c.childNodes, e = 0; e < c.length; e++)b(c[e])
                }
            }
            ...
            return d && (d.nodeType == CKEDITOR.NODE_ELEMENT ||
            ...
            for (var d = this.getAddress(), a = a.getAddress(),
                     b = Math.min(d.length, a.length), c = 0; c < b; c++)if (d[c] != a[c])return d[c] < a[c] ? CKEDITOR.POSITION_PRECEDING : CKEDITOR.POSITION_FOLLOWING;
        ...
        trim: function () {
            ...
            for (; d;) {
                ...
                if (d.hasAttribute("contenteditable"))return d.getAttribute("contenteditable") ==
                    "false";
                d = d.getParent()
            }
            return true
    ...
    (function () {
        ...
        function c(a) {
            for (var b = 0, c = 0, g = h[a].length; c < g; c++)b = b + (parseInt(this.getComputedStyle(h[a][c]) || 0, 10) || 0);
            return b
        }
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype,
            {
                ...
                function a(b,
                    ...
                    if (c && c.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        if (b.isIdentical(c)) {
                            for (var i = g ? b.getLast() : b.getFirst(); d.length;)d.shift().move(b, !g);
                            c.moveChildren(b, !g);
                            c.remove();
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (var b = [], d = 0; d < c.length; d++)if (g)for (var r = 0; r < g.length; r++)b.push([a, c[d], g[r]].join("-")); else b.push([a, c[d]].join("-"));
                    for (a =
                ...
                var b = 0,
                    c = 0, g = this.getDocument(), d = g.getBody(), r = g.$.compatMode == "BackCompat";
                if (document.documentElement.getBoundingClientRect) {
                    var e = this.$.getBoundingClientRect(), o = g.$.documentElement, q = o.clientTop || d.$.clientTop || 0, f = o.clientLeft || d.$.clientLeft || 0, h = true;
                    if (CKEDITOR.env.ie) {
                ...
                e = a.getWindow();
                d = q(this, e);
                var v = q(a, e), B = this.$.offsetHeight;
                g = this.$.offsetWidth;
                var l = a.$.clientHeight, s = a.$.clientWidth;
                ...
                for (var c = this.$.attributes, b = b || {}, g = 0; g < c.length; g++) {
                    var d = c[g], e = d.nodeName.toLowerCase(), f;
                ...
                return function (b) {
                    var c =
                        this.$;
                    if (b.slice)for (b = b.slice(); b.length > 0 && c;)c = a(c, b.shift()); else c = a(c, b);
                ...
                var c = d(this), a = new CKEDITOR.dom.nodeList(this.$.querySelectorAll(b(this, a)));
                c();
                return a
            }, findOne: function (a) {
                var c = d(this),
    ...
    (function () {
        function a(a, b) {
            ...
            g = c.endContainer;
            var e = c.startOffset, f = c.endOffset, h, i = this.guard, l = this.type, s = a ? "getPreviousSourceNode" : "getNextSourceNode";
            if (!a && !this._.guardLTR) {
                var k = g.type == CKEDITOR.NODE_ELEMENT ? g : g.getParent(), m = g.type == CKEDITOR.NODE_ELEMENT ? g.getChild(f) : g.getNext();
                this._.guardLTR = function (a, b) {
                    return (!b || !k.equals(a)) && (!m || !a.equals(m)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            if (a && !this._.guardRTL) {
                var F = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(), p = d.type == CKEDITOR.NODE_ELEMENT ? e ? d.getChild(e - 1) : null : d.getPrevious();
            ...
            if (this.current)g = this.current[s](false, l, h); else {
                if (a)g.type ==
                CKEDITOR.NODE_ELEMENT && (g = f > 0 ? g.getChild(f - 1) : h(g, true) === false ? null : g.getPreviousSourceNode(true, l, h)); else {
                    g = d;
        ...
        var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, f = CKEDITOR.dom.walker.whitespaces(), h = CKEDITOR.dom.walker.bookmark(), i = CKEDITOR.dom.walker.temp();
        ...
        CKEDITOR.dom.walker.empty = function (a) {
            return function (b) {
                for (var c = 0, g = b.getChildCount(); c < g; ++c)if (!j(b.getChild(c)))return !!a;
                return !a
            }
        };
        var n = CKEDITOR.dom.walker.empty(), g = CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(function (a) {
            var b = {}, c;
        ...
        CKEDITOR.dom.element.prototype.getBogus = function () {
            var a = this;
            do a = a.getPreviousSourceNode(); while (h(a) || f(a) || a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$inline) && !a.is(CKEDITOR.dtd.$empty));
    ...
    (function () {
        ...
        function d(a, b, c, d, o) {
            ...
            function f() {
                var a, b, c, g = Math.min(K.length, C.length);
                for (a = 0; a < g; a++) {
                    b = K[a];
                    c = C[a];
            ...
            function h() {
                var b = x - 1, c = z && L && !s.equals(k);
                if (b < D - 1 || b < G - 1 || c) {
                    c ? a.moveToPosition(k,
                        CKEDITOR.POSITION_BEFORE_START) : G == b + 1 && I ? a.moveToPosition(C[b], CKEDITOR.POSITION_BEFORE_END) : a.moveToPosition(C[b + 1], CKEDITOR.POSITION_BEFORE_START);
            ...
            a.optimizeBookmark();
            var i = b === 0, n = b == 1, l = b == 2, b = l || n, s = a.startContainer, k = a.endContainer,
                m = a.startOffset, F = a.endOffset, p, I, z, L, E, u;
            if (l && k.type == CKEDITOR.NODE_TEXT && s.equals(k)) {
                s = a.document.createText(s.substring(m, F));
                c.append(s)
            } else {
                if (k.type == CKEDITOR.NODE_TEXT)l ? u = true : k = k.split(F); else if (k.getChildCount() > 0)if (F >= k.getChildCount()) {
                    k = k.getChild(F - 1);
                    I = true
                } else k = k.getChild(F); else L = I = true;
                if (s.type == CKEDITOR.NODE_TEXT)l ? E = true : s.split(m); else if (s.getChildCount() > 0)if (m === 0) {
                    s = s.getChild(m);
                    p = true
                } else s = s.getChild(m - 1); else z = p = true;
                for (var K = s.getParents(), C = k.getParents(),
                         x = f(), D = K.length - 1, G = C.length - 1, M = c, j, U, T, Z = -1, N = x; N <= D; N++) {
                    U = K[N];
                    T = U.getNext();
        ...
        CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                function a(c) {
                    ...
                    e = g;
                    var f = d;
                    e = e.type != CKEDITOR.NODE_ELEMENT || f ===
                    0 || f == e.getChildCount() ? 0 : e.getChild(f - 1).type == CKEDITOR.NODE_TEXT && e.getChild(f).type == CKEDITOR.NODE_TEXT;
                    if (e) {
                        g = g.getChild(d - 1);
                        d = g.getLength()
                    }
                ...
                if (a.is2) {
                    var b = this.document.getByAddress(a.start, a.normalized), c = a.startOffset, d = a.end &&
                        this.document.getByAddress(a.end, a.normalized), a = a.endOffset;
                    this.setStart(b, c);
                ...
                var c = this.startContainer,
                    d = this.endContainer, c = c.equals(d) ? a && c.type == CKEDITOR.NODE_ELEMENT && this.startOffset == this.endOffset - 1 ? c.getChild(this.startOffset) : c : c.getCommonAncestor(d);
                ...
                var a =
                    this.startContainer, b = this.endContainer;
                ...
                if ((!a || e) && c && c.type == CKEDITOR.NODE_TEXT) {
                    if (d)if (d >= c.getLength()) {
                        ...
                        if (this.startContainer.equals(this.endContainer))this.setEnd(f,
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        var f = this.getCommonAncestor(), h = this.root, i, n, j, l, s, k = false, m, F;
                        ...
                        for (j = c(j); j || l;) {
                            if (j && !l) {
                                ...
                                if (!k ||
                                    j.getComputedStyle("display") != "inline") {
                                    k = false;
                            ...
                            for (; l;) {
                                ...
                                if (l.type == CKEDITOR.NODE_COMMENT)l = l.getPrevious(); else {
                                    if (l.type == CKEDITOR.NODE_TEXT) {
                                        ...
                                        F = l.getText();
                                        if (d.test(F))l = null; else for (var p = l.$.getElementsByTagName("*"), I = 0, z; z = p[I++];)if (!CKEDITOR.dtd.$removeEmpty[z.nodeName.toLowerCase()]) {
                                            l =
                                                null;
                                            break
                                        }
                        ...
                        if (m.type == CKEDITOR.NODE_TEXT)if (CKEDITOR.tools.trim(m.substring(p)).length)k = true; else {
                            k = !m.getLength();
                            if (p == m.getLength()) {
                                ...
                                if (l.type == CKEDITOR.NODE_TEXT) {
                                    ...
                                    if ((l.$.offsetWidth > 0 || b && l.is("br")) && !l.data("cke-bookmark"))if (k && CKEDITOR.dtd.$removeEmpty[l.getName()]) {
                                        ...
                                        if (d.test(F))l = null; else {
                                            ...
                                            for (I = 0; z = p[I++];)if (!CKEDITOR.dtd.$removeEmpty[z.nodeName.toLowerCase()]) {
                                                l = null;
                                                break
                                            }
                                        }
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var E, u, K = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null), C = null, x = function (a) {
                            if (a.type ==
                                CKEDITOR.NODE_ELEMENT && a.getAttribute("contenteditable") == "false")if (C) {
                                if (C.equals(a)) {
                                    C = null;
                                    return
                                }
                ...
                if (!this.collapsed) {
                    var a =
                        a || CKEDITOR.SHRINK_TEXT, d = this.clone(), e = this.startContainer, f = this.endContainer, h = this.startOffset, i = this.endOffset, j = 1, n = 1;
                    if (e && e.type == CKEDITOR.NODE_TEXT)if (h)if (h >= e.getLength())d.setStartAfter(e); else {
                        d.setStartBefore(e);
                        j = 0
                    } else d.setStartBefore(e);
                    if (f && f.type == CKEDITOR.NODE_TEXT)if (i)if (i >= f.getLength())d.setEndAfter(f); else {
                        d.setEndAfter(f);
                        n = 0
                ...
                return {previousBlock: e, nextBlock: f, wasStartOfBlock: c, wasEndOfBlock: d, elementPath: h}
            }, splitElement: function (a, b) {
                if (!this.collapsed)return null;
                this.setEndAt(a, CKEDITOR.POSITION_BEFORE_END);
                var c = this.extractContents(false, b || false), d = a.clone(false, b || false);
                c.appendTo(d);
                d.insertAfter(a);
                ...
                for (var c = 0; a;) {
                    ...
                    if (a.type == CKEDITOR.NODE_ELEMENT)if (a.isEditable()) {
                        ...
                        this.checkEndOfBlock())this.moveToPosition(a, CKEDITOR.POSITION_BEFORE_START); else if (a.getAttribute("contenteditable") == "false" && a.is(CKEDITOR.dtd.$block)) {
                        this.setStartBefore(a);
                        this.setEndAfter(a);
                        return true
                    }
                ...
                var c, d = 0, e, f, h = [CKEDITOR.POSITION_AFTER_END, CKEDITOR.POSITION_BEFORE_START];
                if (a) {
                    c =
                ...
                var a = new CKEDITOR.dom.element.createFromHtml("<span>&nbsp;</span>",
                    this.document), b, c, d, e = this.clone();
                e.optimize();
    ...
    (function () {
        ...
        var e = /^[\r\n\t ]+$/, f = CKEDITOR.dom.walker.bookmark(false, true),
            h = CKEDITOR.dom.walker.whitespaces(true), i = function (a) {
                return f(a) && h(a)
            }, j = {dd: 1, dt: 1, li: 1};
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                if (!this._.started) {
                    ...
                    h = q.startPath();
                    var t = q.endPath(), w = !q.collapsed && c(q, h.block), v = !q.collapsed && c(q, t.block, 1);
                ...
                for (this._.nextNode = null; t;) {
                    var w = 0, v = t.hasAscendant("pre"), B = t.type != CKEDITOR.NODE_ELEMENT, l = 0;
                    if (B)t.type == CKEDITOR.NODE_TEXT && e.test(t.getText()) &&
                    (B = 0); else {
                        var s = t.getName();
                        if (CKEDITOR.dtd.$block[s] && t.getAttribute("contenteditable") == "false") {
                            ...
                            b(this, a, d);
                            break
                        } else if (t.isBlockBoundary(this.forceBrBreak && !v && {br: 1})) {
                    ...
                    if (h && !w)for (; !t.getNext(i) && !r;) {
                        s = t.getParent();
                        if (s.isBlockBoundary(this.forceBrBreak && !v && {br: 1})) {
                            w = 1;
                            B = 0;
                            r || s.equals(q);
                ...
                if (!d) {
                    ...
                    d = new CKEDITOR.dom.elementPath(h.startContainer,
                        h.root);
                    t = d.blockLimit;
                    w = {div: 1, th: 1, td: 1};
                    d = d.block;
                ...
                if (!this._.nextNode)this._.nextNode = r || d.equals(q) || !q ? null : this._getNextSourceNode(d,
                    1, q);
                return d
                ...
                for (var e = this.range.root, a = a.getNextSourceNode(b, null, d); !f(a);)a = a.getNextSourceNode(b, null, d);
                return a
            }
        };
    ...
    (function () {
        function a(a, b, c, d, k) {
            ...
            for (e in b) {
                m = b[e];
                m = typeof m == "boolean" ? {} : typeof m == "function" ? {match: m} : L(m);
                ...
                for (p in C) {
                    f[p] = h(f[p], g) || null;
                    var D = f, u = x[p], o = h(f[x[p]], g), z = f[p], F = [], l = true, s = void 0;
                    o ? l = false : o = {};
                    for (s in z)if (s.charAt(0) == "!") {
                        s = s.slice(1);
                        F.push(s);
                        o[s] = true;
                        l = false
            ...
            for (var b = k.elements, k = k.generic, G, c = 0, d = a.length; c < d; ++c) {
                ...
                for (p in x) {
                    ...
                    o = [];
                    z = void 0;
                    for (z in u)z.indexOf("*") > -1 ? o.push(RegExp("^" + z.replace(/\*/g, ".*") + "$")) : o.push(z);
                    u = o;
                    if (u.length) {
                        f[g] = u;
                        D = false
                ...
                if (e.elements === true || e.elements === null)k[m ? "unshift" : "push"](e); else {
                    f = e.elements;
                    delete e.elements;
                    for (G in f)if (b[G])b[G][m ? "unshift" : "push"](e); else b[G] = [e]
                }
            }
        }
        ...
        function n(a) {
            if (!a)return {};
            for (var a = a.split(/\s*,\s*/).sort(), b = {}; a.length;)b[a.shift()] = u;
            return b
        }
        ...
        function g(a) {
            for (var b, c, d, k, e = {}, m = 1, a = E(a); b = a.match(D);) {
                ...
                e["$" + m++] = {elements: b[1], classes: c, styles: d, attributes: k};
        ...
        function y(a, b, k, e) {
            ...
            if (e.doCallbacks && a.elementCallbacks) {
                a:for (var g = a.elementCallbacks, p = 0, D = g.length, u; p < D; ++p)if (u = g[p](b)) {
                    f = u;
                    break;
                }
                if (f)return f
            ...
            if (e.doTransform)if (f = a._.transformations[b.name]) {
                r(b);
                for (g = 0; g < f.length; ++g)s(a, b, f[g]);
                q(b)
            }
            if (e.doFilter) {
                a:{
                    ...
                    if (!a && !f)a = null; else {
                        ...
                        if (g) {
                            h = 0;
                            for (o = g.length; h < o; ++h)if (c(g[h], b, u) === false) {
                                a = null;
                                break a
                            }
                        }
                        if (p) {
                            h = 0;
                            for (o = p.length; h < o; ++h)c(p[h], b, u)
                        }
                        if (a) {
                            h = 0;
                            for (o = a.length; h <
                        ...
                        if (f) {
                            h = 0;
                            for (o = f.length; h < o; ++h)d(f[h], b, u, D)
                        }
                        a = u
                    }
                }
                ...
                var F = a.validStyles;
                f = a.validClasses;
                var g = b.attributes, l = b.styles, p = b.classes, D = b.classBackup, x = b.styleBackup, C, G, i = [];
                u = [];
                var I = /^data-cke-/;
                h = false;
                delete g.style;
                ...
                if (!a.allAttributes)for (C in g)if (!o[C])if (I.test(C)) {
                ...
                if (!a.allStyles || a.hadInvalidStyle) {
                    for (C in l)a.allStyles || F[C] ? i.push(C + ":" + l[C]) : h = true;
                    if (i.length)g.style = i.sort().join("; ")
                } else if (x)g.style = x;
                if (!a.allClasses || a.hadInvalidClass) {
                    for (C = 0; C < p.length; ++C)(a.allClasses || f[p[C]]) && u.push(p[C]);
        ...
        function l(a, b, c) {
            var d = a.name;
            if (I.$empty[d] || !a.children.length)if (d == "hr" && b == "br")a.replaceWith(v()); else {
                a.parent && c.push({check: "it", el: a.parent});
                a.remove()
            } else if (I.$block[d] || d == "tr")if (b == "br") {
            ...
            } else if (d in{style: 1, script: 1})a.remove(); else {
                a.parent && c.push({check: "it", el: a.parent});
                a.replaceWithChildren()
            }
        }
        ...
        function k(a, b) {
            ...
            for (e in d)if (e == "class") {
                c = d[e].split(/\s+/);
                for (f = a.classes.join("|"); g = c.pop();)if (f.indexOf(g) == -1)return false
            } else if (a.attributes[e] != d[e])return false;
            for (m in k)if (a.styles[m] != k[m])return false;
            return true
        }
        ...
        var I = CKEDITOR.dtd, z = 1, L = CKEDITOR.tools.copy, E = CKEDITOR.tools.trim, u = "cke-test", K = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                if (typeof b == "string")b =
                    g(b); else if (b instanceof CKEDITOR.style) {
                ...
                var k = this, e = [], m = this.editor && this.editor.config.protectedSource, f, g = false, p = {
                    doFilter: !c,
                    doTransform: true,
                    doCallbacks: true,
                    toHtml: b
                ...
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        a:{
                            ...
                            c = [];
                            var D, h, u;
                            if (m)for (h = 0; h < m.length; ++h)if ((u = d.match(m[h])) && u[0].length == d.length) {
                                c = true;
                                break a
                            }
                ...
                e.length && (g = true);
                for (var D,
                         a = [], d = K[d || (this.editor ? this.editor.enterMode : CKEDITOR.ENTER_P)], h; c = e.pop();)c.type == CKEDITOR.NODE_ELEMENT ? l(c, d, a) : c.remove();
                for (; D = a.pop();) {
                    c = D.el;
                    if (c.parent) {
                ...
                var b,
                    c;
                if (!this.disabled && a) {
                    var d = this._.transformations, k;
                    for (k = 0; k < a.length; ++k) {
                        b = a[k];
                        var e = void 0, m = void 0, f = void 0, g = void 0, D = void 0, h = void 0;
                        c = [];
                        for (m = 0; m < b.length; ++m) {
                            ...
                            c.push({check: g == e ? null : g, left: D, right: typeof h == "string" ? p(h) : h})
                        }
                        b = e;
                        d[b] || (d[b] = []);
                        d[b].push(c)
            ...
            check: function (a, b, c) {
                ...
                var m = CKEDITOR.tools.clone(k), f = [], p;
                if (b !== false && (p = this._.transformations[k.name])) {
                    for (d = 0; d < p.length; ++d)s(this, k, p[d]);
                    q(k)
                }
                y(this, m, f, {doFilter: true, doTransform: b !== false, skipRequired: !c, skipFinalValidation: !c});
                b = f.length > 0 ? false :
                    CKEDITOR.tools.objectCompare(k.attributes, m.attributes, true) ? true : false;
                ...
                return function (c, d) {
                    ...
                    for (d || (k = k.reverse()); e = k.pop();)if (this.check(e))return b[e];
        ...
        var C = {styles: 1, attributes: 1, classes: 1}, x = {
            styles: "requiredStyles",
            attributes: "requiredAttributes",
            classes: "requiredClasses"
        }, D = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, G = {
            styles: /{([^}]+)}/,
            attrs: /\[([^\]]+)\]/,
            classes: /\(([^\)]+)\)/
        }, M = /^cke:(object|embed|param)$/, aa = /^(object|embed|param)$/, U = CKEDITOR.filter.transformationsTools = {
            sizeToStyle: function (a) {
                ...
                if (!(c in a.attributes)) {
                    var d = a.styles[b], k = d && d.match(/^(\d+)(?:\.\d*)?px$/);
            ...
            }, matchesStyle: k, transform: function (a, b) {
                if (typeof b == "string")a.name = b; else {
                    var c = b.getDefinition(), d = c.styles, k = c.attributes, e, m, f, g;
                    a.name = c.element;
                    for (e in k)if (e == "class") {
                        c = a.classes.join("|");
                        for (f = k[e].split(/\s+/); g = f.pop();)c.indexOf(g) == -1 &&
                        a.classes.push(g)
    ...
    (function () {
        var a, d = function (b) {
            var b = b.data, d = b.getKeystroke(), f = this.keystrokes[d], h = this._.editor;
            a = h.fire("key", {keyCode: d, domEvent: b}) === false;
            if (!a) {
                f && (a = h.execCommand(f, {from: "keystrokeHandler"}) !== false);
    ...
    CKEDITOR.scriptLoader = function () {
        ...
        return {
            load: function (b, c, e, f) {
                ...
                h && (b = [b]);
                e || (e = CKEDITOR);
                var i = b.length, j = [], n = [], g = function (a) {
    ...
    CKEDITOR.resourceManager.prototype = {
        add: function (a, d) {
            ...
            CKEDITOR.scriptLoader.load(f, function (a, e) {
                ...
                for (var f = 0; f < a.length; f++)for (var g = h[a[f]], j = 0; j < g.length; j++) {
                    var n = g[j];
                    i[n] = this.get(n);
                    c[n] = 1
                }
        ...
        return function (b, c, e) {
            var f = {}, h = function (b) {
                a.call(this, b, function (a) {
                    ...
                    var b = [], g;
                    for (g in a) {
                        var i = a[g], r = i && i.requires;
                        if (!d[g]) {
                            if (i.icons)for (var y = i.icons.split(","), o = y.length; o--;)CKEDITOR.skin.addIcon(y[o], i.path + "icons/" + (CKEDITOR.env.hidpi && i.hidpi ? "hidpi/" : "") + y[o] + ".png");
                            d[g] = 1
                        }
                        if (r) {
                            r.split && (r = r.split(","));
                            for (i = 0; i < r.length; i++)f[r[i]] || b.push(r[i])
                        }
                    }
    ...
    (function () {
        ...
        function h(a, b) {
            a.on("customConfigLoaded", function () {
                ...
                c = a.config;
                a.readOnly = c.readOnly ? true : a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? a.element.is("textarea") ? a.element.hasAttribute("disabled") || a.element.hasAttribute("readonly") :
                    a.element.isReadOnly() : a.elementMode == CKEDITOR.ELEMENT_MODE_REPLACE ? a.element.hasAttribute("disabled") || a.element.hasAttribute("readonly") : false;
        ...
        function j(a) {
            CKEDITOR.lang.load(a.config.language, a.config.defaultLanguage, function (b, c) {
                ...
                a.title =
                    typeof d == "string" || d === false ? d : [a.lang.editor, a.name].join(", ");
        ...
        function g(a) {
            ...
            if (d)var f = RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?=,|$)",
                "g"), c = c.replace(f, ""), c = c + ("," + d);
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                a.plugins = c;
                for (var p in c) {
                    var h = c[p], z = h.lang, i = null, j = h.requires, u;
                    CKEDITOR.tools.isArray(j) && (j = j.join(","));
                    if (j && (u = j.match(g)))for (; j = u.pop();)CKEDITOR.tools.setTimeout(function (a, b) {
        ...
        CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
            addCommand: function (a, b) {
                ...
                if (typeof a != "string")a =
                    (a = this.element) && this.elementMode == CKEDITOR.ELEMENT_MODE_REPLACE ? a.is("textarea") ? a.getValue() : a.getHtml() : "";
                return a
                ...
                for (var a =
                    this.keystrokeHandler.keystrokes, b = CKEDITOR.tools.isArray(arguments[0]) ? arguments[0] : [[].slice.call(arguments, 0)], c, d, e = b.length; e--;) {
                    c = b[e];
                    d = 0;
            ...
            function (f, h, i) {
                function j(a) {
                    ...
                    if (t.length > 0)for (var c = 0; c < t.length; c++) {
                        var d = t[c], e = d.name, f = CKEDITOR.dtd[e], g = v.name && CKEDITOR.dtd[v.name];
                ...
                var o = new CKEDITOR.htmlParser, q = h instanceof CKEDITOR.htmlParser.element ? h : typeof h == "string" ? new CKEDITOR.htmlParser.element(h) : new CKEDITOR.htmlParser.fragment, t = [], w = [], v = q, B = q.name == "textarea", l = q.name == "pre";
                o.onTagOpen = function (e, k, f, g) {
                    k = new CKEDITOR.htmlParser.element(e, k);
                    if (k.isUnknown && f)k.isEmpty =
                        true;
                    k.isOptionalClose = g;
                    if (a(k))t.push(k); else {
                        ...
                        if (e == "br")w.push(k); else {
                            for (; ;) {
                                ...
                                if (!k.isUnknown && !v.isUnknown && !g[e])if (v.isOptionalClose)o.onTagClose(f); else if (e in b && f in b) {
                                    f = v.children;
                ...
                o.onText = function (a) {
                    ...
                    var b = v.name, f = b ? CKEDITOR.dtd[b] || (v._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                    if (!B && !f["#"] && b in d) {
                        o.onTagOpen(e[b] || "");
                        o.onText(a)
                    } else {
        ...
        CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            $: function (b) {
                ...
                addRules: function (a, c) {
                    ...
                    for (var d = [this.elementsRules["^"], this.elementsRules[c.name], this.elementsRules.$], f, h = 0; h < 3; h++)if (f = d[h]) {
                        f = f.exec(a, c, this);
        ...
        a.prototype = {
            add: function (a, c, d) {
                this.rules.splice(this.findIndex(c), 0, {value: a, priority: c, options: d})
                                  ...
                                  c, d) {
                for (var f = [this.findIndex(c), 0], h = 0, i = a.length; h < i; h++)f.push({
                    value: a[h],
                    priority: c,
                    options: d
                });
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, f = Array.prototype.slice.call(arguments, 1), h = this.rules, i = h.length, j, n, g, A;
                for (A = 0; A < i; A++) {
                    if (d) {
                        j = c.type;
                        n = c.name
                    ...
                    g = h[A];
                    if (!(a.nonEditable && !g.options.applyToAll ||
    ...
    (function () {
        function a(a, d) {
            ...
            function g(a, d) {
                return function (e) {
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        for (p = 0; p < g.length; p++)g[p].remove();
                        if (g = !a || (typeof d == "function" ? d(e) : d) !== false)if (!u && !CKEDITOR.env.needsBrFiller &&
                            e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT)g = false; else if (!u && !CKEDITOR.env.needsBrFiller && (document.documentMode > 7 || e.name in CKEDITOR.dtd.tr || e.name in CKEDITOR.dtd.$listItem))g = false; else {
                            g = b(e);
            ...
            var p = {elements: {}}, u = d == "html", z = CKEDITOR.tools.extend({}, l), C;
            for (C in z)"#"in v[C] || delete z[C];
            for (C in z)p.elements[C] = g(u, a.config.fillEmptyBlocks);
            p.root = g(u, false);
        ...
        function q(a, b) {
            for (var c = [], d = b.config.protectedSource, k = b._.dataStore || (b._.dataStore =
                {id: 1}), e = /<\!--\{cke_temp(comment)?\}(\d*?)--\>/g, d = [/<script[\s\S]*?(<\/script>|$)/gi, /<noscript[\s\S]*?<\/noscript>/gi, /<meta[\s\S]*?\/?>/gi].concat(d), a = a.replace(/<\!--[\s\S]*?--\>/g, function (a) {
            ...
            a = a.replace(e, function (a, b, d) {
                return "<\!--" + w + (b ? "{C}" : "") + encodeURIComponent(c[d]).replace(/--/g,
                        "%2D%2D") + "--\>"
            });
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            c.addRules(s);
            c.addRules(k, {applyToAll: true});
            c.addRules(a(b, "data"), {applyToAll: true});
            e.addRules(m);
            e.addRules(F, {applyToAll: true});
            e.addRules(a(b, "html"), {applyToAll: true});
            b.on("toHtml", function (a) {
                var a = a.data, c = a.dataValue, k, c = q(c, b), c = g(c, E), c = n(c), c = g(c, L), c = c.replace(K, "$1cke:$2"), c = c.replace(x, "<cke:$1$2></cke:$1>"), c = c.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"), c = c.replace(/([^a-z0-9<\-])(on\w{3,})(?!>)/gi,
        ...
        var t = /(?:&nbsp;|\xa0)$/, w = "{cke_protected}", v = CKEDITOR.dtd, B = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], l = CKEDITOR.tools.extend({}, v.$blockLimit, v.$block), s = {
                elements: {
                    input: i,
                    textarea: i
                }
            },
            k = {attributeNames: [[/^on/, "data-cke-pa-on"], [/^data-cke-expando$/, ""]]}, m = {
                elements: {
                    embed: function (a) {
                        var b = a.parent;
                        if (b && b.name == "object") {
        ...
        var p = /<(a|area|img|input|source)\b([^>]*)>/gi, I = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, z = /^(href|src|name)$/i, L = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi, E = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi,
            u = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, K = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi, C = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, x = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })();
    "use strict";
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
            type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
                ...
                var d = this, h, i, b = d.getFilterContext(b);
                ...
                for (j in h) {
                    n = j;
                    for (i = h[j]; ;)if (n = a.onAttributeName(b, j))if (n != j) {
                        delete h[j];
                        j = n
                    } else break; else {
                        delete h[j];
                ...
                b && this.filter(b);
                var f = this.name, h = [], i = this.attributes, j, n;
                a.openTag(f, i);
                for (j in i)h.push([j, i[j]]);
    ...
    (function () {
        function a(a, e, f, h) {
            ...
            i.on("loaded", function () {
                b(i);
                h == CKEDITOR.ELEMENT_MODE_REPLACE && (i.config.autoUpdateElement &&
        ...
        function b(a) {
            var b = a.name, d = a.element, h = a.elementMode,
                i = a.fire("uiSpace", {space: "top", html: ""}).html, j = a.fire("uiSpace", {
                    space: "bottom",
                    html: ""
                }).html, n = new CKEDITOR.template('<{outerEl} id="cke_{name}" class="{id} cke cke_reset cke_chrome cke_editor_{name} cke_{langDir} ' + CKEDITOR.env.cssClass + '"  dir="{langDir}" lang="{langCode}" role="application"' + (a.title ? ' aria-labelledby="cke_{name}_arialbl"' : "") + ">" + (a.title ? '<span id="cke_{name}_arialbl" class="cke_voice_label">{voiceLabel}</span>' : "") + '<{outerEl} class="cke_inner cke_reset" role="presentation">{topHtml}<{outerEl} id="{contentId}" class="cke_contents cke_reset" role="presentation"></{outerEl}>{bottomHtml}</{outerEl}></{outerEl}>'),
        ...
        CKEDITOR.editor.prototype.setMode =
            function (a, b) {
                ...
                if (!(a == d.mode || !h || !h[a])) {
                    ...
                    if (d.mode) {
                        var i = d.checkDirty(), h = d._.previousModeData, j, n = 0;
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, d, h) {
            var i = this.container, j = this.ui.space("contents"), n = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement, h = h ? this.container.getFirst(function (a) {
                return a.type == CKEDITOR.NODE_ELEMENT && a.hasClass("cke_inner")
            }) : i;
            h.setSize("width", a, true);
            n && (n.style.width = "1%");
            var g = (h.$.offsetHeight || 0) - (j.$.clientHeight || 0), i = Math.max(b - (d ? 0 : g),
                0), b = d ? b + g : b;
            j.setStyle("height", i + "px");
            n && (n.style.width = "100%");
            this.fire("resize", {outerHeight: b, contentsHeight: i, outerWidth: a || h.getSize("width")})
        };
    ...
    (function () {
        ...
        function e(a) {
            var b = a.editor, c = a.data.path, d = c.blockLimit, e = a.data.selection, h = e.getRanges()[0], l;
            ...
            if (g(b, c.block, d) && h.collapsed && !h.getCommonAncestor().isReadOnly()) {
                ...
                if (!d.checkForward() || c.checkStartOfBlock() &&
                    c.checkEndOfBlock()) {
        ...
        function f(a, b) {
            ...
            var c = b.block || b.blockLimit, d = c && c.getLast(i);
        ...
        function j(a, b) {
            return function (c) {
                var d = c.data.$.toElement || c.data.$.fromElement || c.data.$.relatedTarget, d = d && d.nodeType == CKEDITOR.NODE_ELEMENT ? new CKEDITOR.dom.element(d) : null;
        ...
        function n(a) {
            ...
            var c,
                d = a.getRanges()[0], a = a.root, e = {table: 1, ul: 1, ol: 1, dl: 1};
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            $: function (a, b) {
                ...
                restoreAttrs: function () {
                ...
                }, insertHtmlIntoRange: function (a, b,
                                                  c) {
                    B(this, c || "html", a, b);
                    ...
                    c.focus();
                    c.fire("saveSnapshot");
                    var d = c.activeEnterMode, c = c.getSelection(), e = a.getName(), e = CKEDITOR.dtd.$block[e];
                    b || (b = c.getRanges()[0]);
                    if (this.insertElementIntoRange(a, b)) {
                        b.moveToPosition(a, CKEDITOR.POSITION_AFTER_END);
                        if (e)if ((e = a.getNext(function (a) {
                                return i(a) && !w(a)
                            })) && e.type == CKEDITOR.NODE_ELEMENT && e.is(CKEDITOR.dtd.$block))e.getDtd()["#"] ? b.moveToElementEditStart(e) :
                            b.moveToElementEditEnd(a); else if (!e && d != CKEDITOR.ENTER_BR) {
                    ...
                    l(b);
                    var f, h;
                    if (g)for (; (f = b.getCommonAncestor(0, 1)) && (h = CKEDITOR.dtd[f.getName()]) && (!h || !h[e]);)if (f.getName()in CKEDITOR.dtd.span)b.splitElement(f); else if (b.checkStartOfBlock() && b.checkEndOfBlock()) {
                        b.setStartBefore(f);
                        b.collapse(true);
                        f.remove()
                ...
                getData: function (a) {
                    ...
                    function a() {
                        ...
                        if (d.anchorNode && d.anchorNode ==
                            c.$)e = true; else if (CKEDITOR.env.webkit) {
                    ...
                    e = {doc: this.getDocument(), range: e.clone()};
                    a.detect(e, this);
                    d.exclude(e);
                    b.shrink(e);
                    e.fragment =
                        e.range.cloneContents();
                    c.rebuild(e, this);
                    a.fix(e, this);
                    return new CKEDITOR.dom.documentFragment(e.fragment.$)
                }, extractHtmlFromRange: function (a, b) {
                    var c = s, d = {range: a, doc: a.document}, e = this.getHtmlFromRange(a);
                    if (a.collapsed) {
                        a.optimize();
                        return e
                    }
                    ...
                    if (b) {
                        ...
                        if (d = a.checkStartOfBlock())if (d = a.checkEndOfBlock())if (d = c.block)if (d = !a.root.equals(c.block)) {
                            a:{
                                var d =
                                    c.block.getElementsByTag("span"), g = 0, f;
                                if (d)for (; f = d.getItem(g++);)if (!q(f)) {
                                    d = true;
                                    break a
                                }
                                d = false
                    ...
                    this.attachListener(a, "beforeGetData", function () {
                        var b = this.getData();
                        this.is("textarea") || a.config.ignoreEmptyParagraph !== false && (b = b.replace(v, function (a,
                                                                                                                      b) {
                            return b
                        }));
                        a.setData(b, null, 1)
                    ...
                    if (!this.is("textarea")) {
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in e) {
                                var b = a.getSelection(), g, f = b.getRanges()[0], h = f.startPath(), m, p, l, c = c == 8;
                                if (CKEDITOR.env.ie && CKEDITOR.env.version < 11 && (g = b.getSelectedElement()) || (g = n(b))) {
                                    ...
                                    a.fire("saveSnapshot");
                                    d = 1
                                } else if (h.blockLimit && h.blockLimit.is("td") && (p = h.blockLimit.getAscendant("table")) && f.checkBoundaryOfElement(p,
                                        c ? CKEDITOR.START : CKEDITOR.END) && (l = p[c ? "getPrevious" : "getNext"](o))) {
                                    a.fire("saveSnapshot");
                                    f["moveToElementEdit" + (c ? "End" : "Start")](l);
                        ...
                        CKEDITOR.env.webkit && this.attachListener(a, "key", function (b) {
                            ...
                            if (b in e) {
                                ...
                                if (d.collapsed) {
                                    ...
                                    a:{
                                        var f = b.block;
                                        if (f)if (d[c ? "checkStartOfBlock" : "checkEndOfBlock"]())if (!d.moveToClosestEditablePosition(f, !c) || !d.collapsed)g = false; else {
        ...
        CKEDITOR.on("instanceCreated", function (a) {
            ...
            b.on("mode", function () {
                ...
                if (a && a.isInline()) {
                    ...
                    if (d)if (c = this.ui.space(this.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ?
                            "top" : "contents")) {
        ...
        var o = CKEDITOR.dom.walker.whitespaces(true), q = CKEDITOR.dom.walker.bookmark(false, true), t = CKEDITOR.dom.walker.empty(), w = CKEDITOR.dom.walker.bogus(), v = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi,
            B = function () {
                function a(b) {
                ...
                function b(c, d) {
                    var e, g, f, u, l = [], p = d.range.startContainer;
                    e = d.range.startPath();
                ...
                function c(b, d) {
                    var e = [], g = b.getChildren(), f = g.count(), u, l = 0, m = h[d], p = !b.is(h.$inline) || b.is("br");
                    for (p && e.push(" "); l < f; l++) {
                        u = g.getItem(l);
                ...
                function f(b, c) {
                    ...
                    var e = c.endContainer.getChild(c.endOffset), g = c.endContainer.getChild(c.endOffset -
                        1);
                    e && d(e, b[b.length - 1]);
                    if (g && d(g, b[0])) {
                ...
                return function (l, x, s, G) {
                    var n = l.editor, o = false;
                    if (x == "unfiltered_html") {
                        x = "html";
                        o = true
                    }
                    if (!G.checkReadOnly()) {
                        var E = (new CKEDITOR.dom.elementPath(G.startContainer, G.root)).blockLimit || G.root, l = {
                            type: x, dontFilter: o,
                            editable: l, editor: n, range: G, blockLimit: E, mergeCandidates: [], zombies: []
                        }, x = l.range, G = l.mergeCandidates, r, q;
                        ...
                        if (!x.collapsed) {
                            var n = E.block || E.blockLimit, y = x.getCommonAncestor();
                            n && (!n.equals(y) && !n.contains(y) && x.checkEndOfBlock()) &&
                            l.zombies.push(n);
                            x.deleteContents()
                        }
                        for (; (q = a(x.startContainer) && x.startContainer.getChild(x.startOffset - 1)) && a(q) && q.isBlockBoundary() && o.contains(q);)x.moveToPosition(q, CKEDITOR.POSITION_BEFORE_END);
                        ...
                        (n = r.startNode.getNext(i)) && a(n) && d(n) &&
                        G.push(n);
                        for (n = r.startNode; (n = n.getParent()) && d(n);)G.push(n);
                        x.moveToBookmark(r);
                        if (r = s) {
                            r = l.range;
                            ...
                            if (/^\s+|\s+$/.test(s) && "span"in CKEDITOR.dtd[q])var v = '<span data-cke-marker="1">&nbsp;</span>', s = v + s + v;
                        ...
                        if (r) {
                            ...
                            var H;
                            q = l.blockLimit;
                            var G = 0, J, v = [], w, B, s = n = 0, O, V, x = t.startContainer, o = l.endPath.elements[0], W, E = o.getPosition(x), y = !!o.getCommonAncestor(x) && E != CKEDITOR.POSITION_IDENTICAL && !(E & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED), x = b(l.dataWrapper, l);
                            for (f(x, t); G < x.length; G++) {
                                E = x[G];
                                if (H = E.isLineBreak) {
                                    H = t;
                                    O = q;
                                    var Q = void 0, S = void 0;
                                    if (E.hasBlockSibling)H = 1; else {
                                        Q = H.startContainer.getAscendant(h.$block, 1);
                                        if (!Q || !Q.is({div: 1, p: 1}))H =
                                            0; else {
                                            S = Q.getPosition(O);
                        ...
                        for (W = J.createBookmark(); w = l.zombies.pop();)if (w.getParent()) {
                            B = J.clone();
                            B.moveToElementEditStart(w);
                            B.removeEmptyBlocksAtEnd()
                        }
                        if (V)for (; w = V.pop();)CKEDITOR.env.needsBrFiller ? w.appendBogus() : w.append(J.document.createText(" "));
                        for (; w = l.mergeCandidates.pop();)w.mergeSiblings();
                        J.moveToBookmark(W);
                        if (!l.dontMoveCaret) {
                ...
                return function (d) {
                    var e = d.startContainer, g = e.getAscendant("table", 1), f = false;
                    ...
                    if (g.is("table")) {
                        ...
                        g.is({tbody: 1, thead: 1, tfoot: 1}) && (g =
                            b(g, "tr", f));
        ...
        a = {
            detect: function (a, b) {
                var c = a.range, d = c.clone(), e = c.clone(), g = new CKEDITOR.dom.elementPath(c.startContainer, b), f = new CKEDITOR.dom.elementPath(c.endContainer, b);
                d.collapse(1);
                e.collapse();
                ...
                if (f.block && e.checkBoundaryOfElement(f.block,
                        CKEDITOR.START)) {
        ...
        c = {
            rebuild: function (a, b) {
                var c = a.range,
                    d = c.getCommonAncestor(), e = new CKEDITOR.dom.elementPath(d, b), g = new CKEDITOR.dom.elementPath(c.startContainer, b), c = new CKEDITOR.dom.elementPath(c.endContainer, b), f;
        ...
        b = {
            shrink: function (a) {
                var a = a.range, b = a.startContainer, c = a.endContainer, d = a.startOffset, e = a.endOffset;
            ...
            return {
                list: {
                    detectMerge: function (a, b) {
                        var d = c(b, a.bookmark), e = d.startPath(), g = d.endPath(), f = e.contains(CKEDITOR.dtd.$list), h = g.contains(CKEDITOR.dtd.$list);
                        ...
                        if (a.mergeListBookmark) {
                            var d = a.mergeListBookmark.startNode, e = a.mergeListBookmark.endNode, g = new CKEDITOR.dom.elementPath(d, c), f = new CKEDITOR.dom.elementPath(e, c);
                            if (a.mergeList) {
                    ...
                    detectMerge: function (a, b) {
                        ...
                        if (a.mergeBlockBookmark && !a.purgeTableBookmark) {
                            var d =
                                a.mergeBlockBookmark.startNode, e = a.mergeBlockBookmark.endNode, g = new CKEDITOR.dom.elementPath(d, c), f = new CKEDITOR.dom.elementPath(e, c), g = g.block, f = f.block;
                    ...
                    function a(c) {
                        var e = [], g, f = new CKEDITOR.dom.walker(c), h = c.startPath().contains(d), k = c.endPath().contains(d), l = {};
                    ...
                    return {
                        detectPurge: function (a) {
                            ...
                            var f = c(g, e.bookmark), h = f.clone(), k, l, m = f.getCommonAncestor();
    ...
    (function () {
        ...
        function A(a) {
            ...
            return function (c) {
                ...
                if (b[d]) {
                    ...
                    if (e.length ==
                        1 && g.collapsed)if ((d = g[d < 38 ? "getPreviousEditableNode" : "getNextEditableNode"]()) && d.type == CKEDITOR.NODE_ELEMENT && d.getAttribute("contenteditable") == "false") {
        ...
        var y, o, q = CKEDITOR.dom.walker.invisible(1), t = function () {
            function a(b) {
                return function (a) {
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            e.on("contentDom", function () {
                ...
                function c() {
                    ...
                    j.removeListener("mouseup",
                        c);
                    var a = CKEDITOR.document.$.selection, b = a.createRange();
                    a.type != "None" && b.parentElement().ownerDocument == g.$ && b.select()
                }

                var g = e.document, f = CKEDITOR.document, l = e.editable(), i = g.getBody(), j = g.getDocumentElement(), u = l.isInline(), s, C;
                ...
                l.attachListener(l, CKEDITOR.env.webkit ?
                ...
                if (u && (CKEDITOR.env.webkit || CKEDITOR.env.gecko)) {
                    ...
                    l.attachListener(g.getDocumentElement(), "mouseup",
                        function () {
                            n && d.call(e);
                            n = 0
                        })
        ...
        var w = typeof window.getSelection != "function", v = 1;
        ...
        CKEDITOR.dom.selection.prototype =
        {
            ...
            var a = w ? function () {
                ...
                var b = function (b, c) {
                    ...
                    for (var e = d.children, g, f, h = b.duplicate(), l = 0, k = e.length - 1, i = -1, j, n; l <= k;) {
                        i = Math.floor((l + k) / 2);
                        g = e[i];
                        h.moveToElementText(g);
                        j = h.compareEndPoints("StartToStart", b);
                        if (j > 0)k = i - 1; else if (j < 0)l = i + 1; else return {container: d, offset: a(g)}
                    }
                    ...
                    h = h.text.replace(/(\r\n|\r)/g, "\n").length;
                    if (!h)return {container: d, offset: a(g) + (j > 0 ? 0 : 1)};
                    for (; h > 0;)try {
                    ...
                    return {container: n, offset: j > 0 ? -h : n.nodeValue.length + h}
                };
                return function () {
                ...
                if (f)this.fake(f); else {
                    if (w) {
                        ...
                        for (u = 0; u < a.length; u++) {
                            ...
                            if (f.collapsed && CKEDITOR.env.webkit &&
                                e(f)) {
                                n = this.root;
                                h(n, false);
            ...
            if (a.isFake) {
                ...
                if (!c || c.type != CKEDITOR.NODE_ELEMENT)a.isFake =
                    0
            }
    ...
    (function () {
        ...
        function d(b) {
            ...
            if (b.collapsed) {
                ...
                b.trim();
                var l = b.createBookmark(), n = l.startNode, o = l.endNode, m = n, r;
                if (!i) {
                    var q = b.getCommonAncestor(), i = a(n, q), q = a(o, q);
                ...
                for (m.getPosition(o) == CKEDITOR.POSITION_FOLLOWING && (m = 0); m;) {
                    ...
                    if (m.equals(o)) {
                        ...
                        var p = m.type == CKEDITOR.NODE_ELEMENT ? m.getName() : null, q = p && m.getAttribute("contentEditable") == "false", s = p && m.getAttribute("data-nostyle");
                        ...
                        if (q && j && CKEDITOR.dtd.$block[p])for (var v = m, A = c(v), w = void 0, z = A.length, B = 0, v = z && new CKEDITOR.dom.range(v.getDocument()); B < z; ++B) {
                            var w = A[B], F = CKEDITOR.filter.instances[w.data("cke-filter")];
                            if (F ? F.check(this) : 1) {
                        ...
                        if (A)if ((A = m.getParent()) && ((A.getDtd() || CKEDITOR.dtd.span)[g] || h) && (!f.parentRule || f.parentRule(A))) {
                            if (!r && (!p || !CKEDITOR.dtd.$removeEmpty[p] ||
                                (m.getPosition(o) | L) == L)) {
                                r = b.clone();
                                r.setStartBefore(m)
                            }
                            ...
                            if (p == CKEDITOR.NODE_TEXT || q || p == CKEDITOR.NODE_ELEMENT && !m.getChildCount()) {
                                for (var p = m, S; (i = !p.getNext(I)) && (S = p.getParent(), k[S.getName()]) && (S.getPosition(n) | E) == E && (!f.childRule || f.childRule(S));)p = S;
                                r.setEndAfter(p)
                            }
                    ...
                    if (i && r && !r.collapsed) {
                        for (var i = t(this, e), q = i.hasAttributes(), s = r.getCommonAncestor(), p = {}, A = {}, w = {}, z = {}, R, P, X; i && s;) {
                            if (s.getName() == g) {
                                for (R in f.attributes)if (!z[R] &&
                                    (X = s.getAttribute(P)))i.getAttribute(R) == X ? A[R] = 1 : z[R] = 1;
                                for (P in f.styles)if (!w[P] && (X = s.getStyle(P)))i.getStyle(P) == X ? p[P] = 1 : w[P] = 1
                            }
                            s = s.getParent()
                        }
                        for (R in A)i.removeAttribute(R);
                        for (P in p)i.removeStyle(P);
        ...
        function r(a, b) {
            var c = this._.definition,
                d = c.attributes, c = c.styles, e = B(this)[a.getName()], g = CKEDITOR.tools.isEmpty(d) && CKEDITOR.tools.isEmpty(c), f;
            for (f in d)if (!((f == "class" || this._.definition.fullMatch) && a.getAttribute(f) != l(f, d[f])) && !(b && f.slice(0, 5) == "data-")) {
                g = a.hasAttribute(f);
                a.removeAttribute(f)
            }
            ...
            o(a, e, k[a.getName()]);
            g && (this._.definition.alwaysRemoveElement ? q(a, 1) : !CKEDITOR.dtd.$block[a.getName()] || this._.enterMode ==
        ...
        function v(a, b) {
            for (var c in a)a[c] = a[c].replace(p, function (a,
                                                             c) {
                return b[c]
            })
        }
        ...
        function s(a, b, c) {
            for (var d = a.document, e = a.getRanges(), b = b ? this.removeFromRange : this.applyToRange, g, f = e.createIterator(); g = f.getNextRange();)b.call(this, g, c);
            a.selectRanges(e);
        ...
        }, m =
        {
            ...
            audio: 1,
            video: 1
        }, F = /\s*(?:;\s*|$)/, p = /#\((.+?)\)/g, I = CKEDITOR.dom.walker.bookmark(0, 1), z = CKEDITOR.dom.walker.whitespaces(1);
        ...
        CKEDITOR.style.prototype = {
            apply: function (a) {
                ...
                this.removeFromRange =
                    this.type == CKEDITOR.STYLE_INLINE ? b : this.type == CKEDITOR.STYLE_BLOCK ? i : this.type == CKEDITOR.STYLE_OBJECT ? f : null;
        ...
        var L = CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED, E = CKEDITOR.POSITION_FOLLOWING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED
    })();
    ...
    (function () {
        ...
        CKEDITOR.dom.elementPath = function (b, e) {
            var f = null, h = null, i = [], j = b, n, e = e || b.getDocument().getBody();
    ...
    (function () {
        function a(a, c, d) {
            var f = a.serializable, h = c[d ? "endContainer" : "startContainer"], i = d ? "endOffset" : "startOffset", j = f ? c.document.getById(a.startNode) : a.startNode, a = f ? c.document.getById(a.endNode) : a.endNode;
    ...
    (function () {
        ...
        var h = "cke_ui_color", i = [], j = /\$color/g;
        CKEDITOR.on("instanceLoaded", function (a) {
    ...
    CKEDITOR.plugins.add("dialogui", {
        onLoad: function () {
            ...
            }, !0), t = /^on([A-Z]\w+)/, p = function (b) {
                for (var a in b)(t.test(a) || "title" == a || "type" == a) && delete b[a];
                return b
            }, s = function (b) {
                ...
                labeledElement: function (b, a, d, f) {
                    if (!(4 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.uiElement.call(this, b, a, d, "div", null, e, function () {
                            ...
                            if (a.labelLayout != "horizontal")e.push('<label class="cke_dialog_ui_labeled_label' + g + '" ', ' id="' + c.labelId + '"', c.inputId ? ' for="' + c.inputId + '"' : "", (a.labelStyle ? ' style="' + a.labelStyle + '"' : "") + ">", a.label, "</label>", '<div class="cke_dialog_ui_labeled_content"', a.controlStyle ? ' style="' +
                    ...
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.uiElement.call(this,
                            b, a, d, "span", null, null, function () {
                                ...
                                e.push(' <label id="', d, '" for="', g.id, '"' + (a.labelStyle ? ' style="' + a.labelStyle +
                                    '"' : "") + ">", CKEDITOR.tools.htmlEncode(a.label), "</label>");
                                return e.join("")
                            })
                    }
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function () {
                            for (var e = [], d = [], g = (a.id ? a.id : CKEDITOR.tools.getNextId()) + "_radio", i = 0; i < a.items.length; i++) {
                                var j = a.items[i], h = j[2] !== void 0 ? j[2] : j[0],
                                    l = j[1] !== void 0 ? j[1] : j[0], m = CKEDITOR.tools.getNextId() + "_radio_input", n = m + "_label", m = CKEDITOR.tools.extend({}, a, {
                                        id: m,
                                        title: null,
                                        type: null
                                ...
                                new CKEDITOR.ui.dialog.uiElement(b,
                                    h, q, "label", null, {id: n, "for": o.id}, j[0]);
                                e.push(q.join(""))
                            }
                    ...
                    if (!(3 > arguments.length)) {
                        ...
                        var f = CKEDITOR.tools.extend(h.call(this,
                            a), {definition: a, buttons: []});
                        a.validate && (this.validate = a.validate);
                        b.on("load", function () {
            ...
            CKEDITOR.ui.dialog.radio.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.uiElement, {
                setValue: function (b, a) {
                    ...
                    onChange: function (b, a) {
                        ...
                        }, this), this.on("change", a); else return o.onChange.apply(this,
                            arguments);
                        return null
                    }
                }
            ...
            CKEDITOR.ui.dialog.file.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.labeledElement, n, {
                getInputElement: function () {
                    ...
                    function b() {
                        ...
                        d.$.write(['<html dir="' + g + '" lang="' + i + '"><head><title></title></head><body style="margin: 0; overflow: hidden; background: transparent;">',
                            '<form enctype="multipart/form-data" method="POST" dir="' + g + '" lang="' + i + '" action="', CKEDITOR.tools.htmlEncode(f.action), '"><label id="', a.labelId, '" for="', h, '" style="display:none">', CKEDITOR.tools.htmlEncode(f.label), '</label><input style="width:100%" id="', h, '" aria-labelledby="', a.labelId, '" type="file" name="', CKEDITOR.tools.htmlEncode(f.id || "cke_upload"), '" size="', CKEDITOR.tools.htmlEncode(0 < b ? b : ""), '" /></form></body></html><script>', CKEDITOR.env.ie ? "(" + CKEDITOR.tools.fixDomain + ")();" : "",
                            "window.parent.CKEDITOR.tools.callFunction(" + e + ");", "window.onbeforeunload = function() {window.parent.CKEDITOR.tools.callFunction(" + k + ")}", "<\/script>"].join(""));
                        d.$.close();
    ...
    (function () {
        ...
        function U(a) {
            function b(b) {
                var c = a.getSize(), i = CKEDITOR.document.getWindow().getViewPaneSize(), o = b.data.$.screenX, j = b.data.$.screenY, n = o - e.x, k = j - e.y;
                e = {x: o, y: j};
                d.x += n;
                d.y += k;
        ...
        function V(a) {
            ...
            if (f != CKEDITOR.DIALOG_RESIZE_NONE) {
                var h = a.getParentEditor(),
                    m, l, i, o, j, n = CKEDITOR.tools.addFunction(function (f) {
                        o = a.getSize();
        ...
        function J(a) {
            var b = CKEDITOR.document.getWindow(), c = a.config, e = c.dialog_backgroundCoverColor || "white", d = c.dialog_backgroundCoverOpacity, g = c.baseFloatZIndex, c = CKEDITOR.tools.genKey(e, d, g), f = v[c];
        ...
        CKEDITOR.dialog = function (a, b) {
            ...
            function d(b) {
                if (k == CKEDITOR.dialog._.currentTop) {
                    var c = b.data.getKeystroke(), d = "rtl" == a.lang.dir, f = [37, 38, 39, 40];
                    o = j = 0;
                    if (9 == c || c == CKEDITOR.SHIFT + 9)e(c == CKEDITOR.SHIFT + 9 ? -1 : 1), o = 1; else if (c == CKEDITOR.ALT + 121 && !k._.tabBarMode && 1 < k.getPageCount())k._.tabBarMode = !0, k._.tabs[k._.currentTabId][0].focus(), k._.currentFocusIndex = -1, o = 1; else if (-1 != CKEDITOR.tools.indexOf(f,
                            c) && k._.tabBarMode)c = -1 != CKEDITOR.tools.indexOf([d ? 39 : 37, 38], c) ? t.call(k) : w.call(k), k.selectPage(c), k._.tabs[c][0].focus(), o = 1; else if ((13 == c || 32 == c) && k._.tabBarMode)this.selectPage(this._.currentTabId), this._.tabBarMode = !1, this._.currentFocusIndex = -1, e(1), o = 1; else if (13 == c) {
                        c = b.data.getTarget();
                        if (!c.is("a", "button", "select", "textarea") && (!c.is("input") || "button" != c.$.type))(c = this.getButton("ok")) && CKEDITOR.tools.setTimeout(c.click, 0, c), o = 1;
                        j = 1
                    } else if (27 == c)(c = this.getButton("cancel")) ? CKEDITOR.tools.setTimeout(c.click,
                        0, c) : !1 !== this.fire("cancel", {hide: !0}).hide && this.hide(), j = 1; else return;
                    g(b)
                }
            }
            ...
            var f = CKEDITOR.dialog._.dialogDefinitions[b], h = CKEDITOR.tools.clone(W), m = a.config.dialog_buttonsOrder || "OS", l = a.lang.dir, i = {}, o, j;
            ...
            CKEDITOR.event.call(this);
            this.definition =
                f = CKEDITOR.fire("dialogDefinition", {name: b, definition: f}, a).definition;
            if (!("removeDialogTabs"in a._) && a.config.removeDialogTabs) {
                h = a.config.removeDialogTabs.split(";");
                for (l = 0; l < h.length; l++)if (m = h[l].split(":"), 2 == m.length) {
                    var n = m[0];
                    i[n] || (i[n] = []);
                    i[n].push(m[1])
                }
            ...
            if (a._.removeDialogTabs && (i = a._.removeDialogTabs[b]))for (l = 0; l < i.length; l++)f.removeContents(i[l]);
            ...
            var k = this, p = function (a) {
                var b = k._.contents, c = !1, d;
            ...
            this.on("show", function () {
                ...
                a.config.dialog_startupFocusTab && b ? (k._.tabBarMode = !0, k._.tabs[k._.currentTabId][0].focus(), k._.currentFocusIndex = -1) : this._.hasFocus ||
            ...
            for (l = 0; l < f.contents.length; l++)(i = f.contents[l]) && this.addPage(i);
            ...
            for (l = 0; l < i.length; l++)this._.buttons[i[l].id] = i[l]
        };
        CKEDITOR.dialog.prototype = {
            destroy: function () {
                ...
                if (!g || !this._.position || !(this._.position.x == a && this._.position.y == b))this._.position = {
                    x: a,
                    y: b
                }, g || (g = CKEDITOR.document.getWindow().getScrollPosition(), a += g.x, b += g.y), d && (g = this.getSize(), a = CKEDITOR.document.getWindow().getViewPaneSize().width -
                ...
                this.resize(this._.contentSize && this._.contentSize.width || b.width || b.minWidth, this._.contentSize && this._.contentSize.height || b.height ||
                    b.minHeight);
                this.reset();
                ...
                for (var c in b.contents)if (b.contents[c]) {
                    ...
                    if (e) {
                        ...
                        !g || d && !this._.editor.activeFilter.check(d) ? e[0].addClass("cke_dialog_tab_disabled") :
            ...
            setupContent: function () {
                ...
                if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
                    ...
                    c = CKEDITOR.dom.element.createFromHtml(['<a class="cke_dialog_tab"', 0 < this._.pageCount ?
                        " cke_last" : "cke_first", c, a.hidden ? ' style="display:none"' : "", ' id="', d, '"', e.gecko && !e.hc ? "" : ' href="javascript:void(0)"', ' tabIndex="-1" hidefocus="true" role="tab">', a.label, "</a>"].join(""));
                    ...
                    a.accessKey && (O(this, this, "CTRL+" + a.accessKey, Y, Z),
                ...
                if (this._.currentTabId != a && !this._.tabs[a][0].hasClass("cke_dialog_tab_disabled") && !1 !== this.fire("selectPage", {
                    ...
                    CKEDITOR.env.ie6Compat || CKEDITOR.env.ie7Compat ? (G(d[1]),
                        d[1].show(), setTimeout(function () {
                        G(d[1], 1)
                    }, 0)) : d[1].show();
            ...
            setState: function (a) {
                if (this.state != a) {
                    ...
                    } else a == CKEDITOR.DIALOG_STATE_IDLE &&
        ...
        (function () {
            CKEDITOR.ui.dialog = {
                uiElement: function (a, b, c, e, d, g, f) {
                    if (!(4 > arguments.length)) {
                        var h = (e.call ? e(b) : e) || "div", m = ["<", h, " "], l = (d && d.call ? d(b) : d) || {}, i = (g && g.call ? g(b) : g) || {}, o = (f && f.call ? f.call(this, a, b) : f) || "", j = this.domId = i.id || CKEDITOR.tools.getNextId() + "_uiElement";
                        ...
                        b.disabled &&
                        (n.cke_disabled = 1);
                        for (var k = i["class"] && i["class"].split ? i["class"].split(" ") : [], j = 0; j < k.length; j++)k[j] && (n[k[j]] = 1);
                        k = [];
                        for (j in n)k.push(j);
                        i["class"] = k.join(" ");
                    ...
                    if (!(4 > arguments.length)) {
                        this._ || (this._ = {});
                        var g = this._.children = b, f = d && d.widths || null, h = d && d.height || null, m, l = {role: "presentation"};
                        d && d.align && (l.align = d.align);
                        CKEDITOR.ui.dialog.uiElement.call(this, a, d || {type: "hbox"}, e, "table", {}, l, function () {
    ...
    (function () {
        ...
        function v(b) {
            ...
            function i(a, d) {
                ...
                if (!c.getById("cke_pastebin")) {
                    ...
                    var j = new CKEDITOR.dom.element((CKEDITOR.env.webkit ||
                    e.is("body")) && !CKEDITOR.env.ie ? "body" : "div", c);
                    j.setAttributes({id: "cke_pastebin", "data-cke-temp": "1"});
                    var l = 0, c = c.getWindow();
            ...
            var k = CKEDITOR.plugins.clipboard, m = 0, r = 0, t = 0;
            (function () {
                b.on("key", n);
                b.on("contentDom", a);
            ...
            (function () {
                function a(d, c, e, f, n) {
                    ...
                    b.addMenuItems && b.addMenuItem(c, {label: g, command: c, group: "clipboard", order: n})
                }
            ...
            b.getClipboardData = function (a, d) {
                ...
                function e(b) {
                    ...
                    b.cancel();
                    h = !0;
                    d({type: g, dataValue: b.data, method: "paste"})
                }
        ...
        function x(b, a) {
            ...
            CKEDITOR.env.gecko && b.enterMode != CKEDITOR.ENTER_BR && (CKEDITOR.env.gecko &&
            (a = a.replace(/^<br><br>$/, "<br>")), -1 < a.indexOf("<br><br>") && (a = "<p>" + a.replace(/(<br>){2,}/g, function (b) {
                    return c(b.length / 4)
                }) + "</p>"));
            return y(b, a)
        }
        ...
        function z() {
            ...
            return {
                get: function (d) {
                    ...
                    return d ?
                        new CKEDITOR.filter(d) : null
                }
            }
        }

        function u(b, a, c) {
            var a = CKEDITOR.htmlParser.fragment.fromHtml(a), d = new CKEDITOR.htmlParser.basicWriter;
        ...
        function A(b) {
            b.data.preventDefault();
            b.data.$.dataTransfer.dropEffect =
                "none"
        }
        ...
        function B(b) {
            ...
            b.on("contentDom", function () {
                function c(a, d, c) {
                    d.select();
                    o(b, {dataTransfer: c, method: "drop"}, 1);
                ...
                var f = b.editable(), h = CKEDITOR.plugins.clipboard.getDropTarget(b), i = b.ui.space("top"), s = b.ui.space("bottom");
                ...
                f.attachListener(h, "dragover", function (b) {
                    ...
                    a && a.is && a.is("html") ? b.data.preventDefault() : CKEDITOR.env.ie && (CKEDITOR.plugins.clipboard.isFileApiSupported &&
                    b.data.$.dataTransfer.types.contains("Files")) && b.data.preventDefault()
                });
                ...
                f.attachListener(b, "drop", function (e) {
                    if (e = e.data) {
                        ...
                        h.getTransferType(b) == CKEDITOR.DATA_TRANSFER_INTERNAL ?
                            setTimeout(function () {
            ...
            requires: "dialog", init: function (b) {
                ...
                b.on("paste", function (b) {
                        ...
                        if (a.match(/^<[^<]+cke_(editable|contents)/i)) {
                            var f, h, i = new CKEDITOR.dom.element("div");
                            for (i.setHtml(a); 1 == i.getChildCount() && (f =
                                i.getFirst()) && f.type == CKEDITOR.NODE_ELEMENT && (f.hasClass("cke_editable") || f.hasClass("cke_contents"));)i = h = f;
                ...
                b.on("paste", function (a) {
                    var a = a.data, e = a.type, g = a.dataValue, f, h = b.config.clipboard_defaultContentType || "html", i = a.dataTransfer.getTransferType(b);
                    ...
                    if (document.body.createTextRange) {
                        ...
                        try {
                            ...
                            if (h) {
                                ...
                                var q = a.document.$.elementFromPoint(d, e), k = new CKEDITOR.dom.element(q), o;
                                if (!k.equals(a.editable()) && "html" !=
                                    k.getName())o = k.getClientRect(), d < o.left ? f.setStartAt(k, CKEDITOR.POSITION_AFTER_START) : f.setStartAt(k, CKEDITOR.POSITION_BEFORE_END), f.collapse(!0); else return g && g.startContainer && !g.startContainer.equals(a.editable()) ? g : null
                            }
                        } catch (r) {
                            return null
                        }
        ...
        CKEDITOR.plugins.clipboard.dataTransfer =
            function (b, a) {
                ...
                m && !this.getData("text/plain") && this.setData("text/plain", a.getSelection().getSelectedText()))
            };
        ...
        CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
            getData: function (b) {
                var b = this._.normalizeType(b), a = this._.data[b];
                ...
                if ("text/html" == b) {
                    if (a = a.replace(this._.metaRegExp, ""), (b = this._.bodyRegExp.exec(a)) &&
                ...
                function b(b) {
                    var b = a._.normalizeType(b), c = a.getData(b);
                    c && (a._.data[b] = c)
                }
                ...
                if (a = a || r(b)) {
                    ...
                    if (i && k) {
                        if (c && (c.is("li") || c.getParent().is("li"))) {
                            ...
                            a = c.getParent();
                            e = a.getParent();
                            var h = !c.hasPrevious(), m = !c.hasNext(), l = b.getSelection(), g = l.createBookmarks(), i = c.getDirection(1), k = c.getAttribute("class"), o = c.getAttribute("style"), n = e.getDirection(1) != i, b = b.enterMode != CKEDITOR.ENTER_BR || n || o || k;
            ...
            var j = a.config, m = a.fire("uiSpace", {space: "top", html: ""}).html, p = function () {
                ...
                return function (d) {
                    if (i = a.editable()) {
                        ...
                        k ? (n + o <= c.top ? e("top") : n + o > h.height - c.bottom ? e("pin") : e("bottom"), d = h.width / 2, d = j.floatSpacePreferRight ? "right" : 0 < c.left && c.right < h.width && c.width > l.width ? "rtl" == j.contentsLangDirection ?
    ...
    (function () {
        ...
        function l(a) {
            ...
            } else CKEDITOR.env.ie &&
            (11 > CKEDITOR.env.version && a.config.disableObjectResizing) && d(a)
        }
            ...
            init: function (a) {
                ...
                a.addMode("wysiwyg", function (d) {
                    ...
                    var c = "document.open();" + (CKEDITOR.env.ie ? "(" + CKEDITOR.tools.fixDomain +
                        ")();" : "") + "document.close();", c = CKEDITOR.env.air ? "javascript:void(0)" : CKEDITOR.env.ie && !CKEDITOR.env.edge ? "javascript:void(function(){" + encodeURIComponent(c) + "}())" : "", e = CKEDITOR.dom.element.createFromHtml('<iframe src="' + c + '" frameBorder="0"></iframe>');
                    ...
                    if (h)e.on("load", b);
                    var f = a.title, g = a.fire("ariaEditorHelpLabel",
                        {}).label;
                    f && (CKEDITOR.env.ie && g && (f += ", " + g), e.setAttribute("title", f));
                    if (g) {
                        var f = CKEDITOR.tools.getNextId(), i = CKEDITOR.dom.element.createFromHtml('<span id="' + f + '" class="cke_voice_label">' + g + "</span>");
                        c.append(i, 1);
            ...
            $: function () {
                ...
                setData: function (a, d) {
                    ...
                    if (d)this.setHtml(a), this.fixInitialSelection(), b.fire("dataReady"); else {
                        ...
                        b._.dataStore = {id: 1};
                        var c = b.config, e = c.fullPage, h = c.docType, f = CKEDITOR.tools.buildStyleHtml(m()).replace(/<style>/, '<style data-cke-temp="1">');
                        ...
                        e ? (/<body[\s|>]/.test(a) || (a = "<body>" + a), /<html[\s|>]/.test(a) ||
                        ...
                        c = '<script id="cke_actscrpt" type="text/javascript"' + (CKEDITOR.env.ie ? ' defer="defer" ' : "") + ">var wasLoaded=0;function onload(){if(!wasLoaded)window.parent.CKEDITOR.tools.callFunction(" + this._.frameLoadedHandler + ",window);wasLoaded=1;}" + (CKEDITOR.env.ie ? "onload();" : 'document.addEventListener("DOMContentLoaded", onload, false );') +
                            "<\/script>";
                    ...
                    var a = this.editor, d = a.config, b = d.fullPage, c = b && a.docType, e = b && a.xmlDeclaration, h = this.getDocument(), b = b ? h.getDocumentElement().getOuterHtml() : h.getBody().getHtml();
                    ...
                    var a =
                        this.editor, d = a.document, a = a.window.getFrame();
    ...
    CKEDITOR.plugins.add("notification", {
        requires: "toolbar", init: function (b) {
            ...
            b.showNotification = function (a, d, e) {
                var g, k;
                "progress" == d ? g = e : k = e;
                a = new CKEDITOR.plugins.notification(b, {message: a, type: d, progress: g, duration: k});
                a.show();
                return a
            };
            b.on("key", function (c) {
    ...
    Notification.prototype = {
        show: function () {
            ...
            g && (c.removeClass(this._getClass()), c.removeAttribute("aria-label"),
                this.type = g, c.addClass(this._getClass()), c.setAttribute("aria-label", this.type), "progress" == this.type && !e ? (e = this._createProgressElement(), e.insertBefore(d)) : "progress" != this.type && e && e.remove());
    ...
    Area.prototype = {
        add: function (b) {
            ...
            function b() {
                a.setStyle("left", i(l + d.width - f - h))
            }

            var a = this.element, c = this.editor, d = c.ui.contentsElement.getClientRect(), e = c.ui.contentsElement.getDocumentPosition(), c = c.ui.space("top"), g = c.getClientRect(), k = a.getClientRect(), j, f = this._notificationWidth,
                h = this._notificationMargin;
            j = CKEDITOR.document.getWindow();
            var m = j.getScrollPosition(), n = j.getViewPaneSize(), o = CKEDITOR.document.getBody(), p = o.getDocumentPosition(), i = CKEDITOR.tools.cssLength;
            if (!f || !h)j = this.element.getChild(0), f = this._notificationWidth = j.getClientRect().width, h = this._notificationMargin = parseInt(j.getComputedStyle("margin-left"), 10) + parseInt(j.getComputedStyle("margin-right"), 10);
            c.isVisible() && g.bottom > d.top && g.bottom < d.bottom - k.height ? a.setStyles({
                position: "fixed",
                top: i(g.bottom)
            }) :
                0 < d.top ? a.setStyles({
                    position: "absolute",
                    top: i(e.y)
                }) : e.y + d.height - k.height > m.y ? a.setStyles({
                    position: "fixed",
                    top: 0
                }) : a.setStyles({position: "absolute", top: i(e.y + d.height - k.height)});
            var l = "fixed" == a.getStyle("position") ? d.left : "static" != o.getComputedStyle("position") ? e.x - p.x : e.x;
            d.width < f + h ? e.x + f + h > m.x + n.width ? b() : a.setStyle("left", i(l)) : e.x + f + h > m.x + n.width ? a.setStyle("left", i(l)) : e.x + d.width / 2 + f / 2 + h > m.x + n.width ? a.setStyle("left", i(l - e.x + m.x + n.width - f - h)) : 0 > d.left + d.width - f - h ? b() : 0 > d.left + d.width /
            2 - f / 2 ? a.setStyle("left", i(l - e.x + m.x)) : a.setStyle("left", i(l + d.width / 2 - f / 2 - h / 2))
        }
    };
    CKEDITOR.plugins.notification = Notification;
    (function () {
        function i(a) {
            var b = null != a.config.autosave_SaveKey ? a.config.autosave_SaveKey : "autosave_" + window.location + "_" + a.id, g = null != a.config.autosave_NotOlderThen ? a.config.autosave_NotOlderThen : 1440, c = null != a.config.autosave_saveOnDestroy ? a.config.autosave_saveOnDestroy : !1, d = null != a.config.autosave_saveDetectionSelectors ? a.config.autosave_saveDetectionSelectors : "a[href^='javascript:__doPostBack'][id*='Save'],a[id*='Cancel']";
            CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(CKEDITOR.plugins.getPath("autosave") +
                ...
                if (localStorage.getItem(b)) {
                    ...
                    a.getSnapshot() == d ? localStorage.removeItem(b) : moment(new Date).diff(c, "minutes") > g ? e(b) : (d = a.lang.autosave.loadSavedContent.replace("{0}", moment(c).locale(a.config.language).format(a.lang.autosave.dateFormat)), confirm(d) ? a.openDialog("autosaveDialog") : e(b))
                }
            });
        ...
        function l(a, b, c) {
            var c = h(c), e = difflib.stringAsLines(b.getSnapshot()), d = difflib.stringAsLines(c.data), f = (new difflib.SequenceMatcher(e, d)).get_opcodes();
            a.getContentElement("general", "diffContent").getElement().setHtml('<div class="diffContent">' + diffview.buildView({
                    baseTextLines: e,
                    newTextLines: d,
                    opcodes: f,
        ...
        if (function () {
            ...
            CKEDITOR.plugins.add("autosave", {
                requires: "notification", version: 0.12, init: function (a) {
                    CKEDITOR.document.appendStyleSheet(CKEDITOR.getUrl(CKEDITOR.plugins.getPath("autosave") +
            ...
            var c = 0, f = !1, j = function (a) {
                c && clearTimeout(c);
                c = setTimeout(n, 1E3 * (null != CKEDITOR.config.autosave_delay ? CKEDITOR.config.autosave_delay : 10), a)
            }, n = function (a) {
                if (f)j(a);
                else if (a.editor.checkDirty() || a.editor.plugins.bbcode)f = !0, a = a.editor, k(null != a.config.autosave_SaveKey ? a.config.autosave_SaveKey : "autosave_" + window.location + "_" + a.id, a), f = !1
            }
    ...
    CKEDITOR.config.plugins = 'dialogui,dialog,clipboard,button,toolbar,enterkey,entities,floatingspace,wysiwygarea,undo,notification,autosave,pastetext';
    ...
    (function () {
        ...
        if (CKEDITOR.env.hidpi) setIcons('copy-rtl,0,,copy,24,,cut-rtl,48,,cut,72,,paste-rtl,96,,paste,120,,redo-rtl,144,,redo,168,,undo-rtl,192,,undo,216,,pastetext-rtl,240,,pastetext,264,', 'icons_hidpi.png'); else setIcons('copy-rtl,0,auto,copy,24,auto,cut-rtl,48,auto,cut,72,auto,paste-rtl,96,auto,paste,120,auto,redo-rtl,144,auto,redo,168,auto,undo-rtl,192,auto,undo,216,auto,pastetext-rtl,240,auto,pastetext,264,auto', 'icons.png');
    })();
    CKEDITOR.lang.languages = {"zh-cn": 1, "zh": 1, "en": 1};
}());