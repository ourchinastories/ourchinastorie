...
(function () {
    ...
    e.prototype.groupButtonNamesByGroup = function (b) {
        var a = this, b = e.groupButtons(b), d;
        for (d in b)b[d] = e.map(b[d],
            function (b) {
    ...
    e.prototype.getGroupByName = function (b) {
        for (var a = this.editorInstance.config.toolbarGroups || this.getFullToolbarGroupsConfig(), d = a.length, c = 0; c < d; c += 1)if (a[c].name === b)return a[c];
        return null
    };
    ...
    e.prototype.getFullToolbarGroupsConfig = function (b) {
        for (var b = !0 === b ? !0 : !1, a = [], d = this.editorInstance.toolbar, c =
            d.length, f = 0; f < c; f += 1) {
            var e = d[f], g = {};
    ...
    e.createToolbarButton = function (b) {
        ...
        if (b instanceof CKEDITOR.ui.button)a.addClass("cke_button"), a.addClass("cke_toolgroup"), a.append(d);
            ...
            var d = new CKEDITOR.dom.element("span"), c = new CKEDITOR.dom.element("span"), f = new CKEDITOR.dom.element("span");
    ...
    e.createIcon = function (b, a, d) {
        var c = CKEDITOR.skin.getIconStyle(b, "rtl" == CKEDITOR.lang.dir), c = (c = c || CKEDITOR.skin.getIconStyle(a,
                    "rtl" == CKEDITOR.lang.dir)) || CKEDITOR.skin.getIconStyle(d, "rtl" == CKEDITOR.lang.dir), a = new CKEDITOR.dom.element("span");
    ...
    e.createButton = function (b, a) {
        ...
        if ("string" == typeof a)for (var a = a.split(" "), c = a.length; c--;)d.addClass(a[c]);
        d.setHtml(b);
        return d
    };
